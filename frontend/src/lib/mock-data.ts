...
export function createMockBlocks(docId: string): DocumentBlock[] {
  const blocks: Record<string, DocumentBlock[]> = {
    design: [
      ...
      { id: uid(), documentId: docId, blockType: 'chart3d', content: { title: '📊 月度用户增长', source: '数据来源：代码块 c1', bars: [{ label: '1月', height: 80 }, { label: '2月', height: 120 }, { label: '3月', height: 160 }, { label: '4月', height: 200 }, { label: '5月', height: 240 }, { label: '6月', height: 280 }] }, sortOrder: 14, createdAt: '', updatedAt: '' },
